...
If you have not already explored the codebase, do so to understand the current state of the code. Issue titles and descriptions should use the project's domain vocabulary, and respect architectural decisions in the area you're touching.
...
For each approved slice, create a document with the following structure:
