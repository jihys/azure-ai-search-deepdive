...
- **Orchestration**: Azure Logic Apps (daily crawling), Azure Functions (3개: crawl, preprocess, skills)
...
├── 05-multimodal-indexing     # PDF/PPTX 업로드 + basic/verbalized 파이프라인
└── 06-multimodal-search       # Native vs Verbalized 검색 품질 비교
infra/                          # Bicep IaC
